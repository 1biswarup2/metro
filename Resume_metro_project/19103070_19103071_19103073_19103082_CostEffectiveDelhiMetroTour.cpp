...
int main()
{
  ...
  while(choice==1)
  {
    ...
    printf("2.DEBSHISHU GHOSH [BATCH-B2 ENROLLMENT NO.-19103082]\n");
    printf("3.MEGHA AGARWAL [BATCH-B2 ENROLLMENT NO.-19103070]\n");
    printf("4.PAVINI JAIN [BATCH-B2 ENROLLMENT NO.-19103071]\n\n");
